...
require_relative '../../../lib/chess/pieces/pawn/black_pawn'
...
describe BlackPawn do
  ...
  describe '::starts_at?' do
    context 'when given 1 and 0' do
      it 'returns true' do
        expect(described_class).to be_starting_at(1, 0)
      end
    end

    context 'when given 1 and 1' do
      it 'returns true' do
        expect(described_class).to be_starting_at(1, 1)
      end
    end

    context 'when given 1 and 7' do
      it 'returns true' do
        expect(described_class).to be_starting_at(1, 7)
      end
    end
    ...
    context 'when given 6 and 0' do
      it 'returns false' do
        expect(described_class).not_to be_starting_at(6, 0)
      end
    end
  end
